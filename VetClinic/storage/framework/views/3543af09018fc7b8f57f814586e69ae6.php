...
<div class="login-box bg-white box-shadow border-radius-10">
    ...
    <form action="<?php echo e(route('register')); ?>" method="post">
        ...
        <div class="text-center mt-3">
            <p>Already have an account? <a href="<?php echo e(route('login')); ?>" class="text-primary">Login</a></p>
        </div>
...
<?php echo $__env->make('back.layout.auth-layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\methods\Dental-main\resources\views/logins/register.blade.php ENDPATH**/ ?>