			...
			<div class="menu-block customscroll">
				<div class="sidebar-menu">
					<ul id="accordion-menu">
						...
						<li class="dropdown">
							<a href="<?php echo e(route('appointment.completed')); ?>" class="dropdown-toggle no-arrow">
						...
						<li class="dropdown">
							...
							<ul class="submenu">
								<li>				
							<a href="<?php echo e(route('userTable')); ?>">Manage Users</a>
						</li>
						</ul>
						 <li class="dropdown">
							<a href="javascript:;" class="dropdown-toggle no-arrow">
...
<?php /**PATH C:\laragon\www\methods\Dental-main\resources\views/back/layout/main-layout.blade.php ENDPATH**/ ?>