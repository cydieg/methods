        ...
        <nav class="navbar navbar-expand-lg header-nav">
            ...
            <div class="main-menu-wrapper">
				...
				<ul class="main-nav">
					...
					<li><a href="<?php echo e(route('dentalClinic')); ?>">Clinics</a></li>
					</ul>
            </div>
            <ul class="nav header-navbar-rht">
				...
				<li class="nav-item">
					<a class="nav-link header-login" href="<?php echo e(route('login')); ?>">
						<i class="fas fa-shopping-cart"></i> Appoint Now
					</a>
				</li>
						...
						<div class="col-md-12 col-12">
							<nav aria-label="breadcrumb" class="page-breadcrumb">
								<ol class="breadcrumb">
									...
									<li class="breadcrumb-item active" aria-current="page"><a href="<?php echo e(route('about')); ?>">About</a></li>
									<li class="breadcrumb-item active" aria-current="page"><a href="<?php echo e(route('dentalClinic')); ?>">Clinics</a></li>
								</ol>
							</nav>
						</div>
					</div>
...
<!-- OralEaase/blank-page.html  30 Nov 2019 04:12:20 GMT -->
</html><?php /**PATH C:\laragon\www\methods\Dental-main\resources\views/back/layout/landing-layout.blade.php ENDPATH**/ ?>