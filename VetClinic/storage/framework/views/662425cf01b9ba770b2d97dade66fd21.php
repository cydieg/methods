...
<div class="login-box bg-white box-shadow border-radius-10">
    ...
    <form action="<?php echo e(route('admin.login_handler')); ?>" method="POST">
        ...
        <?php if(Session::get('fall')): ?>
            <div class="alert alert-danger">
                <?php echo e(Session::get('fall')); ?>
...
<?php /**PATH C:\laragon\www\methods\Dental-main\resources\views/back/layout/login-layout.blade.php ENDPATH**/ ?>