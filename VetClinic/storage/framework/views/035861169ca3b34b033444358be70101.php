			...
			<div class="menu-block customscroll">
				<div class="sidebar-menu">
					<ul id="accordion-menu">
						<li class="dropdown">
							<a href="<?php echo e(route('homeStaff')); ?>" class="dropdown-toggle no-arrow">
								<i class="micon bi bi-house-door"></i>
								<span class="mtext">Home</span>
							</a>
						</li>
						<li class="dropdown">
							<a href="<?php echo e(route('staff')); ?>" class="dropdown-toggle no-arrow">
								<i class="micon bi bi-calendar"></i>
								<span class="mtext">Pending Appointment</span>
							</a>
						</li>
						<li class="dropdown">
							<a href="<?php echo e(route('staff.acceptedappoint')); ?>" class="dropdown-toggle no-arrow">
								<i class="micon bi bi-calendar"></i>
...
<?php /**PATH C:\laragon\www\methods\Dental-main\resources\views/back/layout/cashier-layout.blade.php ENDPATH**/ ?>