							...
							<div class="doctor-widget">
								<div class="doc-info-left">
									...
									<div class="doc-info-cont">
										<h4 class="doc-name">Dra. Orense</h4>
										...
										<div class="clinic-details">
											<p class="doc-location"><i class="fas fa-map-marker-alt"></i> Mabini St. Calapan, Philippines - <a href="javascript:void(0);">Get Directions</a></p>
								...
								<div class="doc-info-right">
									<div class="clini-infos">
										<ul>
											...
											<li><i class="fas fa-map-marker-alt"></i> Mabini St. Calapan, Philippines</li>
										...
										<div class="row">
											...
											<div class="col-md-6">
												<div class="clinic-content">
													<h4 class="clinic-name"><a href="#">Orense Dental Clinic</a></h4>
													...
													<div class="clinic-details mb-0">
														<h5 class="clinic-direction"> <i class="fas fa-map-marker-alt"></i> Mabini Street, Calapan, Philippines <br><a href="javascript:void(0);">Get Directions</a></h5>
														<ul>
															<li>
										...
										<div class="row">
											...
											<div class="col-md-6">
												<div class="clinic-content">
													...
													<div class="clinic-details mb-0">
														<p class="clinic-direction"> <i class="fas fa-map-marker-alt"></i> Mabini Street, Calapan City, Philippines <br><a href="javascript:void(0);">Get Directions</a></p>
														<ul>
															<li>
																<a href="assets/img/features/feature-01.jpg" data-fancybox="gallery2">
																	<img src="assets/img/features/feature-01.jpg" alt="Feature Image">
...
<?php echo $__env->make('back.layout.ecom-layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\methods\Dental-main\resources\views/OrenseViewProfile.blade.php ENDPATH**/ ?>