				...
				<div class="sidebar-menu">
					<ul id="accordion-menu">
						...
						<li class="dropdown">
							...
							<ul class="submenu">
								<li>
									<a href="<?php echo e(route('clinics.view')); ?>">View Clinic</a> <!-- Updated link -->
								</li>
							</ul>
						</li>           
						<li class="dropdown">
							...
							<ul class="submenu">
								<li>				
									<a href="<?php echo e(route('superadmin.user.index')); ?>">Manage Users</a>
						</li>
						</ul>
...
<?php /**PATH C:\laragon\www\methods\Dental-main\resources\views/back/layout/superadmin-layout.blade.php ENDPATH**/ ?>