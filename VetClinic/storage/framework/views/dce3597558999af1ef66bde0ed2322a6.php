      ...
      <header class="header">
        <nav class="navbar navbar-expand-lg header-nav">
            ...
            <ul class="nav header-navbar-rht">
				...
				<li class="nav-item">
                    <a class="nav-link header-login" href="<?php echo e(route('login')); ?>">Appoint Now</a>
                </li>
                <li class="nav-item">
...
<!-- OralEase/blank-page.html  30 Nov 2019 04:12:20 GMT -->
</html><?php /**PATH C:\laragon\www\methods\Dental-main\resources\views/welcome.blade.php ENDPATH**/ ?>