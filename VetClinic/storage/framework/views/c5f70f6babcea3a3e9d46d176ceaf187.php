          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <div class="d-flex mx-auto flex-column flex-lg-row align-items-center">
              <ul class="navbar-nav  ">
                ...
                <li class="nav-item">
                  <a class="nav-link" href="<?php echo e(route('ourClinic')); ?>">Clinic</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link" href="<?php echo e(route('ourShop')); ?>"> Our Shop </a>
                </li>
                <li class="nav-item">
            ...
            <div class="quote_btn-container  d-flex justify-content-center">
              <button class="btn light-blue-btn" onclick="location.href='<?php echo e(route('login')); ?>'">Login</button>
            </div>
          </div>
        </nav>
      </div>
...
<?php /**PATH C:\laragon\www\methods\Dental-main\resources\views/back/layout/EcommerceLayout/headerfooter-layout.blade.php ENDPATH**/ ?>