        ...
        <nav class="navbar navbar-expand-lg header-nav">
            ...
            <div class="main-menu-wrapper">
				...
				<ul class="main-nav">
					...
					<li class="nav-item">
					<a class="nav-link header-login" href="<?php echo e(route('customer')); ?>">
			...
			<ul class="nav header-navbar-rht">
				...
				<li class="nav-item user-info-dropdown dropdown">
					...
					<div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
						<a class="dropdown-item" href="<?php echo e(route('manual.logout')); ?>">
					...
					<div class="row align-items-center">
						<div class="col-md-12 col-12">
							<nav aria-label="breadcrumb" class="page-breadcrumb">
								<ol class="breadcrumb">
									<li class="breadcrumb-item"><a href="<?php echo e(route('home1')); ?>">Home</a></li>
									<li class="breadcrumb-item active" aria-current="page"><a href="<?php echo e(route('about2')); ?>">About</a></li>
									<li class="breadcrumb-item active" aria-current="page"><a href="<?php echo e(route('dentalClinic2')); ?>">Clinics</a></li>
								</ol>
							</nav>
						</div>
					</div>
...
<?php /**PATH C:\laragon\www\methods\Dental-main\resources\views/back/layout/ecom-layout.blade.php ENDPATH**/ ?>