...
<!-- OralEase/invoices.html  30 Nov 2019 04:12:14 GMT -->
<head>
		<meta charset="utf-8">
						...
						<div class="row">
							...
							<div class="col-lg-3 col-md-6">
								...
								<div class="footer-widget footer-menu">
									...
									<ul>
                                    <li><a href="search.html"><i class="fas fa-angle-double-right"></i> Search for Branch</a></li>
								...
								<div class="footer-widget footer-contact">
									...
									<div class="footer-contact-info">
										<div class="footer-address">
											...
											<p> JP SubStreet, San Vicente East, Calapan City Oriental Mindoro</p>
										</div>
										<p>
